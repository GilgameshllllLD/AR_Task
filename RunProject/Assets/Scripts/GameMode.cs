...
public class GameMode : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        guidObj.transform.position = new Vector3(0,-3, 0);
    ...
    private void Update()
    {
        ...
        //        Vector3 pos = roads[i].transform.position;
        //        Quaternion rot = roads[i].transform.rotation;
        //        float offsetZ = (pos.z - 0.01f);
        //        pos.Set(pos.x, pos.y, offsetZ);
        //        roads[i].transform.SetPositionAndRotation(pos, rot);

        //       //if(offsetZ < -1.0f)
        //       // {
        //       //     Destroy(roads[i], 1.0f);
        //       // }
        //    }
        //    //if(roads.Count<3)
        //    //{
