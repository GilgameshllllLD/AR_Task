...
{
class CustomStandardShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent textureBlendLabel = new GUIContent("Texture Blend");
	...
	MaterialProperty textureBlend = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
		...
		textureBlend = FindProperty ("_TextureBlend", props);
	}
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			m_MaterialEditor.ShaderProperty(textureBlend, Styles.textureBlendLabel.text);
		}
		if (EditorGUI.EndChangeCheck())
		{
