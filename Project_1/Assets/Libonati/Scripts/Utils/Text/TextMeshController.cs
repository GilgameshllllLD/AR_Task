...
#region monobehavior methods.
    ...
    public void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay( GetInitPosition() + transform.up*0.05f, transform.right * m_lastWidth );
...
#region private methods.
    ...
    private float GetWordWidth( string word )
    {
        ...
        float width = m_textMesh.GetComponent<Renderer>().bounds.extents.x * 2.0f;
        return width;
    }
